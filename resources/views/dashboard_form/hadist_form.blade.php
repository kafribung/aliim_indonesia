<div class="form-group">
    <label for="title" class="control-label mb-1">Tentang</label>
...
<div class="form-group">
    <label for="info" class="control-label mb-1">Periwayat</label>
...
<div class="form-group">
    <label for="description" class="control-label mb-1">Hadist</label>
