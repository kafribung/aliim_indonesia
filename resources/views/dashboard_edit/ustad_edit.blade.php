                        ...
                        <div class="card-body">
                            <form action="/ustad/{{$ustad->id}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="{{url($ustad->takeImg)}}" alt="Gambar {{$ustad->name}}"
                                        title="Gambar {{$ustad->name}}" width="100" height="100">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="email" name="email" email="email"
                                        ...
                                        required value="{{old('email') ? old('email') : $ustad->email}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="date_birth" name="date_birth" type="date"
                                        ...
                                        autocomplete="off"
                                        value="{{old('date_birth') ? old('date_birth') : $ustad->date_birth}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="provinci" name="provinci"
                                        ...
                                        <option {{ $ustad->provinci == $provinci['nama'] ? 'selected' : '' }}
