                        ...
                        <div class="card-body">
                            <form action="/admin/{{$admin->id}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="{{url($admin->img)}}" alt="Gambar {{$admin->name}}" title="Gambar {{$admin->name}}" width="100" height="100">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="name" name="name" type="text" class="form-control @error('name') is-invalid @enderror"  required autocomplete="off" value="{{old('name') ? old('name') : $admin->name}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="date_birth" name="date_birth" type="date" class="form-control @error('date_birth') is-invalid @enderror"  required autocomplete="off" value="{{old('date_birth') ? old('date_birth') : $admin->date_birth}}">
